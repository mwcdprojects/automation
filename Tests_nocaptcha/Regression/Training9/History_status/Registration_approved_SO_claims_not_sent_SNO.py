# Registration awaiting SO Approval.
"""
Validate History table when Registration is awaiting SO Approval.
If registration approved by SO and claims are not sent to SNO for approval
Registration -  Approved by SO. Beneficiary Verification Pending
claim1 - Registration approved by SO. Registration Pending Verification
claim2 - Registration approved by SO. Registration Pending Verification
claim3 - Registration approved by SO. Registration Pending Verification
"""
...
class login(unittest.TestCase):
    ...
    def test_01(self):
        ...
        time.sleep(1)
        self.driver.find_element_by_id("txtNameAsInAadhar").send_keys("Ramyaaa")
        time.sleep(1)
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath("//input[@id='txtAccountHoldersName']").send_keys("Ramyaaa")
        time.sleep(2)
        ...
        time.sleep(1)
        self.driver.find_element_by_xpath("//input[@class='grid-filter-input form-control']").send_keys("Ramyaaa")
        time.sleep(1)
        ...
        self.driver.find_elements_by_xpath("//select[@id='beneficiaryAltID']/option")[2].click()
        time.sleep(2)
        self.driver.find_element_by_id("txtAlternateNumber").send_keys(self.aadhaar1)
        time.sleep(2)
        ...
        try:
            assert self.driver.find_element_by_link_text(
                self.aadhaar1).text == self.aadhaar1, "Search by Aadhaar for the number {} failed".format(
                        self.aadhaar1)
        except:
            print "Aadhaar search failed"
        finally:
            print "Aadhaar search for the number {} is validated ".format(self.aadhaar1)
        ...
        self.assertEqual(
            ...
            "Approved by SO. Beneficiary Verification Pending")
        self.assertEqual(
            self.driver.find_element_by_xpath("//table[@class='table table-bordered']/tbody/tr[2]/td[5]").text,
            "Registration approved by SO. Registration Pending Verification")
        self.assertEqual(
