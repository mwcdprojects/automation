...
"""
Testcase :Difference between Reg and LMP can be greater than 150 days.
Expected Result: Beneficiary registration successful.
...
class login(unittest.TestCase):
    ...
    def test_01(self):
        ...
        #self.assertTrue(self.driver.find_element_by_xpath("//div[@class='col-md-12']/h5").text , "The beneficiary will not be eligible to apply for benefits under the scheme as the beneficiary has received first and second instalment under old MBP scheme (IGMSY)")
