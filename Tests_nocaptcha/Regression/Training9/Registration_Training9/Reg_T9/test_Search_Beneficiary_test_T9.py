...
import string
import random
import Tests_nocaptcha.Regression.Training9.Registration_Training9.Parallel_Regs.verhoeff
...
class login(unittest.TestCase):
    def setUp(self):
        ...
        self.health_id = "H" + ''.join(random.choice(string.ascii_letters) for i in range(4)) + ''.join(
            random.choice(string.digits) for i in range(4))
        self.aadhaar1 = Tests_nocaptcha.Regression.Training9.Registration_Training9.Parallel_Regs.verhoeff.VerhoeffChecksum().generateVerhoeff(''.join(random.choice(string.digits) for i in range(1, 12)))
        self.aadhaar2 = Tests_nocaptcha.Regression.Training9.Registration_Training9.Parallel_Regs.verhoeff.VerhoeffChecksum().generateVerhoeff(''.join(random.choice(string.digits) for i in range(1, 12)))
